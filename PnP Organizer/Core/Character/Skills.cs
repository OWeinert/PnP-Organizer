    ...
    public class Skills
    {
        ...
        private Skills()
        {
            ...
            Assassinate = AddSkill(new Skill(Resources.Skills_SkillAssassinate, SkillCategory.Melee, 2, 
                ...
                new StatModifier[] { new CalculatorModifierStatModifier(CalculatorValueType.Damage, ApplianceMode.EndValue, 3, CalculatorBonusType.Multiplicative)}, 
            ...
            DefensiveFighting = CreateAndAddSkill(Resources.Skills_SkillDefensiveFighting, SkillCategory.Melee, 2, 
                ...
                new StatModifier[] 
                { 
                    new CalculatorModifierStatModifier(CalculatorValueType.Parry, ApplianceMode.BaseValue, 2),
                    new CalculatorModifierStatModifier(CalculatorValueType.Hit, ApplianceMode.BaseValue, -2),
                },
                new string[] { AimedAttackMelee.Name, ArmorBreaker.Name, Assassinate.Name, WeaponsAndArmor.Name, JumpAttack.Name, Taunt.Name });
            ...
            Parade = CreateAndAddSkill(Resources.Skills_SkillHeavyParade, SkillCategory.Melee, 2, 
                ...
                new StatModifier[] { new CalculatorModifierStatModifier(CalculatorValueType.Parry, ApplianceMode.BaseValue, Dice.D4) },
            ...
            Feint = CreateAndAddSkill(Resources.Skills_SkillFeint, SkillCategory.Melee, 2, 
                ...
                new StatModifier[] { new CalculatorModifierStatModifier(CalculatorValueType.Hit, ApplianceMode.BaseValue, 4) },
            ...
            DevastatingAttack = CreateAndAddSkill(Resources.Skills_SkillDevastatingAttack, SkillCategory.Melee, 2, 
                ...
                new StatModifier[] { new CalculatorModifierStatModifier(CalculatorValueType.Damage, ApplianceMode.EndValue, 2, CalculatorBonusType.Multiplicative) },
            ...
            DefensiveStance = CreateAndAddSkill(Resources.Skills_SkillDefensiveStance, SkillCategory.Melee, 2,
                ...
                new StatModifier[] 
                {
                    new CalculatorModifierStatModifier(CalculatorValueType.Armor, ApplianceMode.EndValue, 2, CalculatorBonusType.Multiplicative),
                    new CalculatorModifierStatModifier(CalculatorValueType.Parry, ApplianceMode.BaseValue, Dice.D6, 2),
                },
                new string[] { Fencing.Name, DuplexFerrum.Name, HeavyParade.Name, PerfectBlock.Name, SkillfulRetreat.Name, Feint.Name, DevastatingAttack.Name });
            ...
            AccurateMelee = CreateAndAddSkill(Resources.Skills_SkillAccurateMelee, SkillCategory.Melee, 2, 
                ...
                new StatModifier[] { new CalculatorModifierStatModifier(CalculatorValueType.Parry, ApplianceMode.BaseValue, 2) },
                new string[] { Fencing.Name, DuplexFerrum.Name, HeavyParade.Name, PerfectBlock.Name, SkillfulRetreat.Name, Feint.Name, DevastatingAttack.Name });
            ...
            CripplingBlow = CreateAndAddSkill(Resources.Skills_SkillCripplingBlow, SkillCategory.Melee, 2,
                ...
                new StatModifier[] { new CalculatorModifierStatModifier(CalculatorValueType.Hit, ApplianceMode.BaseValue, -1) }, 
            ...
            EveryBlowAHit = CreateAndAddSkill(Resources.Skills_SkillEveryBlowAHit, SkillCategory.Melee, 2, 
                ...
                new StatModifier[] { new CalculatorModifierStatModifier(CalculatorValueType.Hit, ApplianceMode.BaseValue, 2) },
            ...
            LoneWarrior = CreateAndAddSkill(Resources.Skills_SkillLoneWarrior, SkillCategory.Melee, 2, 
                ...
                new StatModifier[] 
                { 
                    new CalculatorModifierStatModifier(CalculatorValueType.Damage, ApplianceMode.BaseValue, 1),
                    new CalculatorModifierStatModifier(CalculatorValueType.Hit, ApplianceMode.BaseValue, 1),
                    new CalculatorModifierStatModifier(CalculatorValueType.Parry, ApplianceMode.BaseValue, 1),
                    new CalculatorModifierStatModifier(CalculatorValueType.Armor, ApplianceMode.BaseValue, 1),
                },
                new string[] { HijackerMelee.Name, Armor.Name, ArmorUp.Name, Combo.Name, PerfectBlow.Name, EveryBlowAHit.Name, TakeAHit.Name });
            ...
            StrongThrow = CreateAndAddSkill(Resources.Skills_SkillStrongThrow, SkillCategory.Ranged, 2, 
                ...
                new StatModifier[] { new CalculatorModifierStatModifier(CalculatorValueType.Damage, ApplianceMode.BaseValue, Dice.D6) },
            ...
            ProfessionalSlingshotMarksman = CreateAndAddSkill(Resources.Skills_SkillProfessionalSlingshotMarksman, SkillCategory.Ranged, 2, 
                ...
                { 
                    new CalculatorModifierStatModifier(CalculatorValueType.Hit, ApplianceMode.BaseValue, 2),
                    new CalculatorModifierStatModifier(CalculatorValueType.Damage, ApplianceMode.BaseValue, Dice.D6, 2)
                }, 
                new string[]{ AccurateRanged.Name });
            ...
            SurpriseAttack = CreateAndAddSkill(Resources.Skills_SkillSurpriseAttack, SkillCategory.Ranged, 2, 
                ...
                new StatModifier[] { new CalculatorModifierStatModifier(CalculatorValueType.Damage, ApplianceMode.BaseValue, Dice.D4) },
            ...
            QuickAim = CreateAndAddSkill(Resources.Skills_SkillQuickAim, SkillCategory.Ranged, 2, 
                ...
                new StatModifier[] { new CalculatorModifierStatModifier(CalculatorValueType.Hit, ApplianceMode.BaseValue, -3) },
                new string[] { HijackerRanged.Name, BowMaking.Name, RoutinedWithThrowingWeapons.Name, Headshot.Name, ProfessionalSlingshotMarksman.Name, PerfectShot.Name });
            ...
            LuckyShot = CreateAndAddSkill(Resources.Skills_SkillLuckyShot, SkillCategory.Ranged, 2, 
                ...
                new StatModifier[] { new CalculatorModifierStatModifier(CalculatorValueType.Hit, ApplianceMode.BaseValue, -6) },
            ...
            LastShot = CreateAndAddSkill(Resources.Skills_SkillLastShot, SkillCategory.Ranged, 2, 
                ...
                new StatModifier[] 
                { 
                    new CalculatorModifierStatModifier(CalculatorValueType.Hit, ApplianceMode.BaseValue, Dice.D6),
                    new CalculatorModifierStatModifier(CalculatorValueType.Damage, ApplianceMode.BaseValue, FileIO.LoadedCharacter.Pearls.Wood * 2.5)
                },
                new string[] { SurpriseAttack.Name, PiercingArrow.Name, LuckyShot.Name, Magazine.Name, MasterfulArcher.Name });
